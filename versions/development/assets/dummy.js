...
;define('dummy/components/docs/uxs-menu/horizontal-demo', ['exports'], function (exports) {
  'use strict';
...
;define('dummy/components/docs/uxs-menu/vertical-demo', ['exports'], function (exports) {
  'use strict';
...
;define('dummy/ember-ux-sauce/tests/addon.lint-test', [], function () {
  ...
  QUnit.test('addon/mixins/styleable.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'addon/mixins/styleable.js should pass ESLint\n\n20:5 - Unexpected console statement. (no-console)');
  });
...
;define("dummy/snippets", ["exports"], function (exports) {
  ...
  exports.default = {
    ...
    "menu-divider-demo.hbs": "\n    {{#uxs-menu\n      horizontal=horizontal\n      align=align\n      detail=detail\n      style=style\n    as |menu|\n    }}\n      {{menu.item \"Users\"}}\n      {{menu.item \"Locations\"}}\n      {{menu.divider}}\n      {{menu.item \"Things\"}}\n      {{menu.item \"Widgets\"}}\n      {{menu.divider}}\n      {{menu.item \"Account\"}}\n      {{menu.item \"Logout\"}}\n    {{/uxs-menu}}\n",
    "menu-dropdown-demo-demo.hbs": "\n    {{#basic-dropdown as |dropdown|}}\n      {{#dropdown.trigger}}\n        {{uxs-button \"Dropdown Menu\" style=\"primary\"}}\n      {{/dropdown.trigger}}\n      {{#dropdown.content}}\n        {{#uxs-menu as |menu|}}\n          {{#menu.item}}Normal nav item{{/menu.item}}\n          {{#menu.item}}And another{{/menu.item}}\n          {{menu.separator}}\n          {{#menu.link \"docs.index\"}}This one is a link{{/menu.link}}\n        {{/uxs-menu}}\n      {{/dropdown.content}}\n    {{/basic-dropdown}}\n",
    "menu-horizontal-demo.hbs": "\n    {{#uxs-menu horizontal=true align=align detail=detail style=style as |menu|}}\n      {{menu.item \"Maps\"}}\n      {{menu.item \"Books\"}}\n      {{menu.item \"Flights\"}}\n      {{menu.item \"App\"}}\n    {{/uxs-menu}}\n",
    ...
    "menu-item-demo.hbs": "\n    {{#uxs-menu horizontal=horizontal align=align detail=detail style=style as |menu|}}\n      {{menu.item \"Item\"}}\n      {{menu.item \"Disabled Item\" disabled=true}}\n      {{menu.link \"Link\" \"docs.quickstart\"}}\n      {{menu.link \"Disabled Link\" \"docs.quickstart\" disabled=true}}\n    {{/uxs-menu}}\n",
    ...
    "menu-subheading-demo.hbs": "\n    {{#uxs-menu\n      hasRightIcon=true\n      detail=detail\n      style=style\n    as |menu|\n    }}\n      {{menu.subheading \"Sort by\"}}\n      {{menu.item \"Age\"}}\n      {{menu.item \"Surname\" rightIcon=\"arrow_upward\"}}\n      {{menu.item \"Location\"}}\n      {{menu.subheading \"Filter by\"}}\n      {{menu.item \"Age\"}}\n      {{menu.item \"Surname\" rightIcon=\"done\"}}\n      {{menu.item \"Location\"}}\n    {{/uxs-menu}}\n",
    "menu-subheadings": "\n    <div class=\"f fr\">\n\n      <div class=\"mr\">\n        {{#uxs-menu hasLeftIcon=true as |menu|}}\n          {{menu.subheading \"Sort by\"}}\n          {{menu.item \"Age\"}}\n          {{menu.item \"Surname\" leftIcon=\"arrow_upward\"}}\n          {{menu.item \"Location\"}}\n        {{/uxs-menu}}\n      </div>\n      <div>\n        {{#uxs-menu hasLeftIcon=true as |menu|}}\n          {{menu.subheading \"Filter by\"}}\n          {{menu.item \"Age\"}}\n          {{menu.item \"Surname\" leftIcon=\"done\"}}\n          {{menu.item \"Location\"}}\n        {{/uxs-menu}}\n      </div>\n    </div>\n",
    "menu-vertical-demo.hbs": "\n    <div class=\"f fr\">\n      <div class=\"mr\">\n        {{#uxs-menu align=align detail=detail style=style as |menu|}}\n          {{menu.item \"Maps\"}}\n          {{menu.item \"Books\"}}\n          {{menu.item \"Flights\"}}\n          {{menu.item \"Apps\"}}\n        {{/uxs-menu}}\n      </div>\n      <div class=\"mr\">\n        {{#uxs-menu align=align detail=detail style=style as |menu|}}\n          {{menu.item \"Refresh\"}}\n          {{menu.item \"Help & Feedback\"}}\n          {{menu.item \"Settings\"}}\n          {{menu.item \"Sign out\"}}\n        {{/uxs-menu}}\n      </div>\n    </div>\n",
...
;define("dummy/templates/components/docs/uxs-menu/divider-demo", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "kNiZgkb7", "block": "{\"symbols\":[\"demo\",\"table\",\"row\",\"row\",\"row\",\"row\",\"menu\"],\"statements\":[[4,\"docs-demo\",null,null,{\"statements\":[[0,\"\\n\"],[4,\"component\",[[22,1,[\"example\"]]],[[\"name\"],[\"menu-divider-demo.hbs\"]],{\"statements\":[[0,\"\\n\"],[4,\"uxs-menu\",null,[[\"horizontal\",\"align\",\"detail\",\"style\"],[[23,[\"horizontal\"]],[23,[\"align\"]],[23,[\"detail\"]],[23,[\"style\"]]]],{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"Users\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"Locations\"],null],false],[0,\"\\n      \"],[1,[22,7,[\"divider\"]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"Things\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"Widgets\"],null],false],[0,\"\\n      \"],[1,[22,7,[\"divider\"]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"Account\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"Logout\"],null],false],[0,\"\\n\"]],\"parameters\":[7]},null],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"args-table\",[\"menu-divider-demo\"],null,{\"statements\":[[4,\"component\",[[22,2,[\"row\"]],\"align\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,6,[\"label\"]],\"Align\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,6,[\"input\"]],[23,[\"align\"]]],[[\"options\"],[\"align-directions\"]]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,6,[\"type\"]],\"String\"],null],false],[0,\"\\n\"]],\"parameters\":[6]},null],[4,\"component\",[[22,2,[\"row\"]],\"detail\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,5,[\"label\"]],\"Detail\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"checkbox\"]],[23,[\"detail\"]]],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"type\"]],\"Bolean\"],null],false],[0,\"\\n\"]],\"parameters\":[5]},null],[4,\"component\",[[22,2,[\"row\"]],\"horizontal\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,4,[\"label\"]],\"Horizontal\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,4,[\"checkbox\"]],[23,[\"horizontal\"]]],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,4,[\"type\"]],\"Bolean\"],null],false],[0,\"\\n\"]],\"parameters\":[4]},null],[4,\"component\",[[22,2,[\"row\"]],\"style\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,3,[\"label\"]],\"Style\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,3,[\"input\"]],[23,[\"style\"]]],[[\"options\"],[\"styles\"]]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,3,[\"type\"]],\"String\"],null],false],[0,\"\\n\"]],\"parameters\":[3]},null]],\"parameters\":[2]},null],[0,\"\\n  \"],[1,[27,\"component\",[[22,1,[\"snippet\"]],\"menu-divider-demo.hbs\"],null],false],[0,\"\\n\\n\"]],\"parameters\":[1]},null]],\"hasEval\":false}", "meta": { "moduleName": "dummy/templates/components/docs/uxs-menu/divider-demo.hbs" } });
});
;define("dummy/templates/components/docs/uxs-menu/dropdown-demo", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "dEuejSdn", "block": "{\"symbols\":[\"demo\",\"dropdown\",\"menu\"],\"statements\":[[4,\"docs-demo\",null,null,{\"statements\":[[0,\"\\n\"],[4,\"component\",[[22,1,[\"example\"]]],[[\"name\"],[\"menu-dropdown-demo-demo.hbs\"]],{\"statements\":[[0,\"\\n\"],[4,\"basic-dropdown\",null,null,{\"statements\":[[4,\"component\",[[22,2,[\"trigger\"]]],null,{\"statements\":[[0,\"        \"],[1,[27,\"uxs-button\",[\"Dropdown Menu\"],[[\"style\"],[\"primary\"]]],false],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"component\",[[22,2,[\"content\"]]],null,{\"statements\":[[4,\"uxs-menu\",null,null,{\"statements\":[[0,\"          \"],[4,\"component\",[[22,3,[\"item\"]]],null,{\"statements\":[[0,\"Normal nav item\"]],\"parameters\":[]},null],[0,\"\\n          \"],[4,\"component\",[[22,3,[\"item\"]]],null,{\"statements\":[[0,\"And another\"]],\"parameters\":[]},null],[0,\"\\n          \"],[1,[22,3,[\"separator\"]],false],[0,\"\\n          \"],[4,\"component\",[[22,3,[\"link\"]],\"docs.index\"],null,{\"statements\":[[0,\"This one is a link\"]],\"parameters\":[]},null],[0,\"\\n\"]],\"parameters\":[3]},null]],\"parameters\":[]},null]],\"parameters\":[2]},null],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n  \"],[1,[27,\"component\",[[22,1,[\"snippet\"]],\"menu-dropdown-demo-demo.hbs\"],null],false],[0,\"\\n\\n\"]],\"parameters\":[1]},null]],\"hasEval\":false}", "meta": { "moduleName": "dummy/templates/components/docs/uxs-menu/dropdown-demo.hbs" } });
});
;define("dummy/templates/components/docs/uxs-menu/horizontal-demo", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "2k/zk6Gr", "block": "{\"symbols\":[\"demo\",\"table\",\"row\",\"row\",\"row\",\"menu\"],\"statements\":[[4,\"docs-demo\",null,null,{\"statements\":[[0,\"\\n\"],[4,\"component\",[[22,1,[\"example\"]]],[[\"name\"],[\"menu-horizontal-demo.hbs\"]],{\"statements\":[[0,\"\\n\"],[4,\"uxs-menu\",null,[[\"horizontal\",\"align\",\"detail\",\"style\"],[true,[23,[\"align\"]],[23,[\"detail\"]],[23,[\"style\"]]]],{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,6,[\"item\"]],\"Maps\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,6,[\"item\"]],\"Books\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,6,[\"item\"]],\"Flights\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,6,[\"item\"]],\"App\"],null],false],[0,\"\\n\"]],\"parameters\":[6]},null],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"args-table\",[\"menu-horizontal-demo\"],null,{\"statements\":[[4,\"component\",[[22,2,[\"row\"]],\"align\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,5,[\"label\"]],\"Align\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"input\"]],[23,[\"align\"]]],[[\"options\"],[\"align-directions\"]]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"type\"]],\"String\"],null],false],[0,\"\\n\"]],\"parameters\":[5]},null],[4,\"component\",[[22,2,[\"row\"]],\"detail\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,4,[\"label\"]],\"Detail\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,4,[\"checkbox\"]],[23,[\"detail\"]]],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,4,[\"type\"]],\"Bolean\"],null],false],[0,\"\\n\"]],\"parameters\":[4]},null],[4,\"component\",[[22,2,[\"row\"]],\"style\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,3,[\"label\"]],\"Style\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,3,[\"input\"]],[23,[\"style\"]]],[[\"options\"],[\"styles\"]]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,3,[\"type\"]],\"String\"],null],false],[0,\"\\n\"]],\"parameters\":[3]},null]],\"parameters\":[2]},null],[0,\"\\n  \"],[1,[27,\"component\",[[22,1,[\"snippet\"]],\"menu-horizontal-demo.hbs\"],null],false],[0,\"\\n\\n\"]],\"parameters\":[1]},null]],\"hasEval\":false}", "meta": { "moduleName": "dummy/templates/components/docs/uxs-menu/horizontal-demo.hbs" } });
});
;define("dummy/templates/components/docs/uxs-menu/icon-demo", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "VIk3A5YC", "block": "{\"symbols\":[\"demo\",\"table\",\"row\",\"row\",\"row\",\"row\",\"menu\",\"menu\"],\"statements\":[[4,\"docs-demo\",null,null,{\"statements\":[[0,\"\\n\"],[4,\"component\",[[22,1,[\"example\"]]],[[\"name\"],[\"menu-icon-demo.hbs\"]],{\"statements\":[[0,\"\\n    \"],[7,\"div\"],[11,\"class\",\"f fr\"],[9],[0,\"\\n      \"],[7,\"div\"],[11,\"class\",\"mr\"],[9],[0,\"\\n\"],[4,\"uxs-menu\",null,[[\"hasLeftIcon\",\"horizontal\",\"align\",\"detail\",\"style\"],[true,[23,[\"horizontal\"]],[23,[\"align\"]],[23,[\"detail\"]],[23,[\"style\"]]]],{\"statements\":[[0,\"          \"],[1,[27,\"component\",[[22,8,[\"item\"]],\"Preview\"],[[\"leftIcon\"],[\"visibility\"]]],false],[0,\"\\n          \"],[1,[27,\"component\",[[22,8,[\"item\"]],\"Share\"],[[\"leftIcon\"],[\"person_add\"]]],false],[0,\"\\n          \"],[1,[27,\"component\",[[22,8,[\"item\"]],\"Get Links\"],[[\"disabled\",\"leftIcon\"],[true,\"link\"]]],false],[0,\"\\n          \"],[1,[27,\"component\",[[22,8,[\"item\"]],\"Make Copy\"],[[\"leftIcon\"],[\"content_copy\"]]],false],[0,\"\\n          \"],[1,[27,\"component\",[[22,8,[\"item\"]],\"Download\"],[[\"leftIcon\"],[\"file_download\"]]],false],[0,\"\\n          \"],[1,[27,\"component\",[[22,8,[\"item\"]],\"YouTube\"],[[\"leftIcon\"],[\"delete\"]]],false],[0,\"\\n          \"],[1,[27,\"component\",[[22,8,[\"item\"]],\"Logout\"],null],false],[0,\"\\n\"]],\"parameters\":[8]},null],[0,\"      \"],[10],[0,\"\\n      \"],[7,\"div\"],[11,\"class\",\"mr\"],[9],[0,\"\\n\"],[4,\"uxs-menu\",null,[[\"hasRightIcon\",\"horizontal\",\"align\",\"detail\",\"style\"],[true,[23,[\"horizontal\"]],[23,[\"align\"]],[23,[\"detail\"]],[23,[\"style\"]]]],{\"statements\":[[0,\"          \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"Clear Config\"],null],false],[0,\"\\n          \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"New Config\"],[[\"disabled\",\"rightIcon\"],[true,\"person_add\"]]],false],[0,\"\\n          \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"Project\"],[[\"rightIcon\"],[\"settings\"]]],false],[0,\"\\n          \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"Workspace\"],[[\"rightIcon\"],[\"settings\"]]],false],[0,\"\\n          \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"Bold\"],[[\"rightIcon\"],[\"format_bold\"]]],false],[0,\"\\n          \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"Italic\"],[[\"rightIcon\"],[\"format_italic\"]]],false],[0,\"\\n\"]],\"parameters\":[7]},null],[0,\"      \"],[10],[0,\"\\n    \"],[10],[0,\"\\n\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"args-table\",[\"menu-icon-demo\"],null,{\"statements\":[[4,\"component\",[[22,2,[\"row\"]],\"align\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,6,[\"label\"]],\"Align\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,6,[\"input\"]],[23,[\"align\"]]],[[\"options\"],[\"align-directions\"]]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,6,[\"type\"]],\"String\"],null],false],[0,\"\\n\"]],\"parameters\":[6]},null],[4,\"component\",[[22,2,[\"row\"]],\"detail\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,5,[\"label\"]],\"Detail\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"checkbox\"]],[23,[\"detail\"]]],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"type\"]],\"Bolean\"],null],false],[0,\"\\n\"]],\"parameters\":[5]},null],[4,\"component\",[[22,2,[\"row\"]],\"horizontal\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,4,[\"label\"]],\"Horizontal\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,4,[\"checkbox\"]],[23,[\"horizontal\"]]],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,4,[\"type\"]],\"Bolean\"],null],false],[0,\"\\n\"]],\"parameters\":[4]},null],[4,\"component\",[[22,2,[\"row\"]],\"style\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,3,[\"label\"]],\"Style\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,3,[\"input\"]],[23,[\"style\"]]],[[\"options\"],[\"styles\"]]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,3,[\"type\"]],\"String\"],null],false],[0,\"\\n\"]],\"parameters\":[3]},null]],\"parameters\":[2]},null],[0,\"\\n  \"],[1,[27,\"component\",[[22,1,[\"snippet\"]],\"menu-icon-demo.hbs\"],null],false],[0,\"\\n\\n\"]],\"parameters\":[1]},null]],\"hasEval\":false}", "meta": { "moduleName": "dummy/templates/components/docs/uxs-menu/icon-demo.hbs" } });
});
;define("dummy/templates/components/docs/uxs-menu/item-demo", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "xMovnaSF", "block": "{\"symbols\":[\"demo\",\"table\",\"row\",\"row\",\"row\",\"row\",\"menu\"],\"statements\":[[4,\"docs-demo\",null,null,{\"statements\":[[0,\"\\n\"],[4,\"component\",[[22,1,[\"example\"]]],[[\"name\"],[\"menu-item-demo.hbs\"]],{\"statements\":[[0,\"\\n\"],[4,\"uxs-menu\",null,[[\"horizontal\",\"align\",\"detail\",\"style\"],[[23,[\"horizontal\"]],[23,[\"align\"]],[23,[\"detail\"]],[23,[\"style\"]]]],{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"Item\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"Disabled Item\"],[[\"disabled\"],[true]]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,7,[\"link\"]],\"Link\",\"docs.quickstart\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,7,[\"link\"]],\"Disabled Link\",\"docs.quickstart\"],[[\"disabled\"],[true]]],false],[0,\"\\n\"]],\"parameters\":[7]},null],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"args-table\",[\"menu-item-demo\"],null,{\"statements\":[[4,\"component\",[[22,2,[\"row\"]],\"align\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,6,[\"label\"]],\"Align\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,6,[\"input\"]],[23,[\"align\"]]],[[\"options\"],[\"align-directions\"]]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,6,[\"type\"]],\"String\"],null],false],[0,\"\\n\"]],\"parameters\":[6]},null],[4,\"component\",[[22,2,[\"row\"]],\"detail\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,5,[\"label\"]],\"Detail\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"checkbox\"]],[23,[\"detail\"]]],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"type\"]],\"Bolean\"],null],false],[0,\"\\n\"]],\"parameters\":[5]},null],[4,\"component\",[[22,2,[\"row\"]],\"horizontal\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,4,[\"label\"]],\"Horizontal\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,4,[\"checkbox\"]],[23,[\"horizontal\"]]],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,4,[\"type\"]],\"Bolean\"],null],false],[0,\"\\n\"]],\"parameters\":[4]},null],[4,\"component\",[[22,2,[\"row\"]],\"style\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,3,[\"label\"]],\"Style\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,3,[\"input\"]],[23,[\"style\"]]],[[\"options\"],[\"styles\"]]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,3,[\"type\"]],\"String\"],null],false],[0,\"\\n\"]],\"parameters\":[3]},null]],\"parameters\":[2]},null],[0,\"\\n  \"],[1,[27,\"component\",[[22,1,[\"snippet\"]],\"menu-item-demo.hbs\"],null],false],[0,\"\\n\\n\"]],\"parameters\":[1]},null]],\"hasEval\":false}", "meta": { "moduleName": "dummy/templates/components/docs/uxs-menu/item-demo.hbs" } });
});
;define("dummy/templates/components/docs/uxs-menu/secondary-text-demo", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "faCRDIDz", "block": "{\"symbols\":[\"demo\",\"table\",\"row\",\"row\",\"menu\"],\"statements\":[[4,\"docs-demo\",null,null,{\"statements\":[[0,\"\\n\"],[4,\"component\",[[22,1,[\"example\"]]],[[\"name\"],[\"menu-secondary-text-demo.hbs\"]],{\"statements\":[[0,\"\\n\"],[4,\"uxs-menu\",null,[[\"hasSecondaryText\",\"detail\",\"style\"],[true,[23,[\"detail\"]],[23,[\"style\"]]]],{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,5,[\"item\"]],\"Open\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"item\"]],\"Paste in place\"],[[\"secondaryText\"],[\"Shift + V\"]]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"item\"]],\"Research\"],[[\"secondaryText\"],[\"Opt + Shift + Cmd + I\"]]],false],[0,\"\\n\"]],\"parameters\":[5]},null],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"args-table\",[\"menu-secondary-text-demo\"],null,{\"statements\":[[4,\"component\",[[22,2,[\"row\"]],\"detail\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,4,[\"label\"]],\"Detail\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,4,[\"checkbox\"]],[23,[\"detail\"]]],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,4,[\"type\"]],\"Bolean\"],null],false],[0,\"\\n\"]],\"parameters\":[4]},null],[4,\"component\",[[22,2,[\"row\"]],\"style\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,3,[\"label\"]],\"Style\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,3,[\"input\"]],[23,[\"style\"]]],[[\"options\"],[\"styles\"]]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,3,[\"type\"]],\"String\"],null],false],[0,\"\\n\"]],\"parameters\":[3]},null]],\"parameters\":[2]},null],[0,\"\\n  \"],[1,[27,\"component\",[[22,1,[\"snippet\"]],\"menu-secondary-text-demo.hbs\"],null],false],[0,\"\\n\\n\"]],\"parameters\":[1]},null]],\"hasEval\":false}", "meta": { "moduleName": "dummy/templates/components/docs/uxs-menu/secondary-text-demo.hbs" } });
});
;define("dummy/templates/components/docs/uxs-menu/subheading-demo", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "5iF/Mmlt", "block": "{\"symbols\":[\"demo\",\"table\",\"row\",\"row\",\"menu\"],\"statements\":[[4,\"docs-demo\",null,null,{\"statements\":[[0,\"\\n\"],[4,\"component\",[[22,1,[\"example\"]]],[[\"name\"],[\"menu-subheading-demo.hbs\"]],{\"statements\":[[0,\"\\n\"],[4,\"uxs-menu\",null,[[\"hasRightIcon\",\"detail\",\"style\"],[true,[23,[\"detail\"]],[23,[\"style\"]]]],{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,5,[\"subheading\"]],\"Sort by\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"item\"]],\"Age\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"item\"]],\"Surname\"],[[\"rightIcon\"],[\"arrow_upward\"]]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"item\"]],\"Location\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"subheading\"]],\"Filter by\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"item\"]],\"Age\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"item\"]],\"Surname\"],[[\"rightIcon\"],[\"done\"]]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"item\"]],\"Location\"],null],false],[0,\"\\n\"]],\"parameters\":[5]},null],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"args-table\",[\"menu-subheading-demo\"],null,{\"statements\":[[4,\"component\",[[22,2,[\"row\"]],\"detail\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,4,[\"label\"]],\"Detail\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,4,[\"checkbox\"]],[23,[\"detail\"]]],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,4,[\"type\"]],\"Bolean\"],null],false],[0,\"\\n\"]],\"parameters\":[4]},null],[4,\"component\",[[22,2,[\"row\"]],\"style\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,3,[\"label\"]],\"Style\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,3,[\"input\"]],[23,[\"style\"]]],[[\"options\"],[\"styles\"]]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,3,[\"type\"]],\"String\"],null],false],[0,\"\\n\"]],\"parameters\":[3]},null]],\"parameters\":[2]},null],[0,\"\\n  \"],[1,[27,\"component\",[[22,1,[\"snippet\"]],\"menu-subheading-demo.hbs\"],null],false],[0,\"\\n\\n\"]],\"parameters\":[1]},null]],\"hasEval\":false}", "meta": { "moduleName": "dummy/templates/components/docs/uxs-menu/subheading-demo.hbs" } });
});
;define("dummy/templates/components/docs/uxs-menu/vertical-demo", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "Yz/iU4sl", "block": "{\"symbols\":[\"demo\",\"table\",\"row\",\"row\",\"row\",\"menu\",\"menu\"],\"statements\":[[4,\"docs-demo\",null,null,{\"statements\":[[0,\"\\n\"],[4,\"component\",[[22,1,[\"example\"]]],[[\"name\"],[\"menu-vertical-demo.hbs\"]],{\"statements\":[[0,\"\\n    \"],[7,\"div\"],[11,\"class\",\"f fr\"],[9],[0,\"\\n      \"],[7,\"div\"],[11,\"class\",\"mr\"],[9],[0,\"\\n\"],[4,\"uxs-menu\",null,[[\"align\",\"detail\",\"style\"],[[23,[\"align\"]],[23,[\"detail\"]],[23,[\"style\"]]]],{\"statements\":[[0,\"          \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"Maps\"],null],false],[0,\"\\n          \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"Books\"],null],false],[0,\"\\n          \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"Flights\"],null],false],[0,\"\\n          \"],[1,[27,\"component\",[[22,7,[\"item\"]],\"Apps\"],null],false],[0,\"\\n\"]],\"parameters\":[7]},null],[0,\"      \"],[10],[0,\"\\n      \"],[7,\"div\"],[11,\"class\",\"mr\"],[9],[0,\"\\n\"],[4,\"uxs-menu\",null,[[\"align\",\"detail\",\"style\"],[[23,[\"align\"]],[23,[\"detail\"]],[23,[\"style\"]]]],{\"statements\":[[0,\"          \"],[1,[27,\"component\",[[22,6,[\"item\"]],\"Refresh\"],null],false],[0,\"\\n          \"],[1,[27,\"component\",[[22,6,[\"item\"]],\"Help & Feedback\"],null],false],[0,\"\\n          \"],[1,[27,\"component\",[[22,6,[\"item\"]],\"Settings\"],null],false],[0,\"\\n          \"],[1,[27,\"component\",[[22,6,[\"item\"]],\"Sign out\"],null],false],[0,\"\\n\"]],\"parameters\":[6]},null],[0,\"      \"],[10],[0,\"\\n    \"],[10],[0,\"\\n\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"args-table\",[\"menu-vertical-demo\"],null,{\"statements\":[[4,\"component\",[[22,2,[\"row\"]],\"align\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,5,[\"label\"]],\"Align\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"input\"]],[23,[\"align\"]]],[[\"options\"],[\"align-directions\"]]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,5,[\"type\"]],\"String\"],null],false],[0,\"\\n\"]],\"parameters\":[5]},null],[4,\"component\",[[22,2,[\"row\"]],\"detail\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,4,[\"label\"]],\"Detail\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,4,[\"checkbox\"]],[23,[\"detail\"]]],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,4,[\"type\"]],\"Bolean\"],null],false],[0,\"\\n\"]],\"parameters\":[4]},null],[4,\"component\",[[22,2,[\"row\"]],\"style\"],null,{\"statements\":[[0,\"      \"],[1,[27,\"component\",[[22,3,[\"label\"]],\"Style\"],null],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,3,[\"input\"]],[23,[\"style\"]]],[[\"options\"],[\"styles\"]]],false],[0,\"\\n      \"],[1,[27,\"component\",[[22,3,[\"type\"]],\"String\"],null],false],[0,\"\\n\"]],\"parameters\":[3]},null]],\"parameters\":[2]},null],[0,\"\\n  \"],[1,[27,\"component\",[[22,1,[\"snippet\"]],\"menu-vertical-demo.hbs\"],null],false],[0,\"\\n\\n\"]],\"parameters\":[1]},null]],\"hasEval\":false}", "meta": { "moduleName": "dummy/templates/components/docs/uxs-menu/vertical-demo.hbs" } });
});
...
;define("dummy/templates/docs/components/menus", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "D1e1Ifba", "block": "{\"symbols\":[],\"statements\":[[7,\"div\"],[11,\"class\",\"docs-md\"],[9],[7,\"h1\"],[11,\"id\",\"menus\"],[11,\"class\",\"docs-md__h1\"],[9],[0,\"Menus\"],[10],[0,\"\\n    \"],[7,\"p\"],[9],[0,\"The uxs menu component is used to display lists of links and actions.\"],[10],[0,\"\\n\"],[7,\"p\"],[9],[0,\"To see a full list of arguments check out the \"],[7,\"a\"],[11,\"href\",\"/docs/api/components/uxs-menu\"],[11,\"class\",\"docs-md__a\"],[9],[0,\"api page\"],[10],[10],[0,\"\\n\\n      \"],[7,\"h2\"],[11,\"id\",\"simple-vertical-usage\"],[11,\"class\",\"docs-md__h2\"],[9],[7,\"a\"],[11,\"href\",\"#simple-vertical-usage\"],[11,\"class\",\"heading-anchor\"],[9],[0,\"Simple Vertical Usage\"],[10],[10],[0,\"\\n    \"],[7,\"p\"],[9],[0,\"Two simple examples. The menu widths adjusts to accommodate the content in keyline increments.\"],[10],[0,\"\\n\"],[7,\"p\"],[9],[1,[21,\"docs/uxs-menu/vertical-demo\"],false],[10],[0,\"\\n\\n      \"],[7,\"h2\"],[11,\"id\",\"simple-vertical-usage\"],[11,\"class\",\"docs-md__h2\"],[9],[7,\"a\"],[11,\"href\",\"#simple-vertical-usage\"],[11,\"class\",\"heading-anchor\"],[9],[0,\"Simple Vertical Usage\"],[10],[10],[0,\"\\n    \"],[7,\"p\"],[9],[0,\"This example shows a menu rendered horizontally\"],[10],[0,\"\\n\"],[7,\"p\"],[9],[1,[21,\"docs/uxs-menu/horizontal-demo\"],false],[10],[0,\"\\n\\n      \"],[7,\"h2\"],[11,\"id\",\"menu-items\"],[11,\"class\",\"docs-md__h2\"],[9],[7,\"a\"],[11,\"href\",\"#menu-items\"],[11,\"class\",\"heading-anchor\"],[9],[0,\"Menu Items\"],[10],[10],[0,\"\\n    \"],[7,\"p\"],[9],[0,\"The menu yeilds two components for handling items.\"],[10],[0,\"\\n\"],[7,\"ul\"],[9],[0,\"\\n\"],[7,\"li\"],[9],[0,\"Use \"],[7,\"em\"],[9],[0,\"item\"],[10],[0,\" if you want to bind an action to the item - \"],[7,\"a\"],[11,\"href\",\"/docs/api/components/uxs-menu/item\"],[11,\"class\",\"docs-md__a\"],[9],[0,\"api page\"],[10],[10],[0,\"\\n\"],[7,\"li\"],[9],[0,\"Use \"],[7,\"em\"],[9],[0,\"link\"],[10],[0,\" if you want to transition to another route - \"],[7,\"a\"],[11,\"href\",\"/docs/api/components/uxs-menu/route\"],[11,\"class\",\"docs-md__a\"],[9],[0,\"api page\"],[10],[10],[0,\"\\n\"],[10],[0,\"\\n\"],[7,\"p\"],[9],[0,\"The following demo shows both in use as well as a disabled state for individual items.\"],[10],[0,\"\\n\"],[7,\"p\"],[9],[1,[21,\"docs/uxs-menu/item-demo\"],false],[10],[0,\"\\n\\n      \"],[7,\"h2\"],[11,\"id\",\"icons\"],[11,\"class\",\"docs-md__h2\"],[9],[7,\"a\"],[11,\"href\",\"#icons\"],[11,\"class\",\"heading-anchor\"],[9],[0,\"Icons\"],[10],[10],[0,\"\\n    \"],[7,\"p\"],[9],[0,\"Menu items & links support icons through the \"],[7,\"em\"],[9],[0,\"leftIcon\"],[10],[0,\" and \"],[7,\"em\"],[9],[0,\"rightIcon\"],[10],[0,\" attributes.\"],[10],[0,\"\\n\"],[7,\"p\"],[9],[0,\"You can pass true to \"],[7,\"em\"],[9],[0,\"hasLeftIcon\"],[10],[0,\" & \"],[7,\"em\"],[9],[0,\"hasRightIcon\"],[10],[0,\" on the menu to ensure items without icons inherit the relevant padding.\"],[10],[0,\"\\n\"],[7,\"p\"],[9],[1,[21,\"docs/uxs-menu/icon-demo\"],false],[10],[0,\"\\n\\n      \"],[7,\"h2\"],[11,\"id\",\"dividers\"],[11,\"class\",\"docs-md__h2\"],[9],[7,\"a\"],[11,\"href\",\"#dividers\"],[11,\"class\",\"heading-anchor\"],[9],[0,\"Dividers\"],[10],[10],[0,\"\\n    \"],[7,\"p\"],[9],[0,\"Menus can include dividers to seperate items. These work on both vertical and horizontal menus.\"],[10],[0,\"\\n\"],[7,\"p\"],[9],[1,[21,\"docs/uxs-menu/divider-demo\"],false],[10],[0,\"\\n\\n      \"],[7,\"h2\"],[11,\"id\",\"secondary-text\"],[11,\"class\",\"docs-md__h2\"],[9],[7,\"a\"],[11,\"href\",\"#secondary-text\"],[11,\"class\",\"heading-anchor\"],[9],[0,\"Secondary Text\"],[10],[10],[0,\"\\n    \"],[7,\"p\"],[9],[0,\"Menu items & links support secondary text through the _\"],[7,\"em\"],[9],[0,\"secondaryText\"],[10],[0,\" attribute. This text will be displayed aligned right of the main text.\"],[10],[0,\"\\n\"],[7,\"p\"],[9],[0,\"You can pass true to \"],[7,\"em\"],[9],[0,\"hasSecondaryText\"],[10],[0,\" on the menu to ensure items without secondary text inherit the relevant padding.\"],[10],[0,\"\\n\"],[7,\"p\"],[9],[0,\"Secondary Text is only supported on left aligned & vertical menus.\"],[10],[0,\"\\n\"],[7,\"p\"],[9],[1,[21,\"docs/uxs-menu/secondary-text-demo\"],false],[10],[0,\"\\n\\n      \"],[7,\"h2\"],[11,\"id\",\"subheadings\"],[11,\"class\",\"docs-md__h2\"],[9],[7,\"a\"],[11,\"href\",\"#subheadings\"],[11,\"class\",\"heading-anchor\"],[9],[0,\"Subheadings\"],[10],[10],[0,\"\\n    \"],[7,\"p\"],[9],[0,\"Menu Items can include subheadings to split up items. Subheadings are not clickable.\"],[10],[0,\"\\n\"],[7,\"p\"],[9],[0,\"View the subheading api \"],[7,\"a\"],[11,\"href\",\"/docs/api/components/uxs-subheading\"],[11,\"class\",\"docs-md__a\"],[9],[0,\"api page\"],[10],[10],[0,\"\\n\"],[7,\"p\"],[9],[1,[21,\"docs/uxs-menu/subheading-demo\"],false],[10],[0,\"\\n\\n      \"],[7,\"h2\"],[11,\"id\",\"dropdown-menu\"],[11,\"class\",\"docs-md__h2\"],[9],[7,\"a\"],[11,\"href\",\"#dropdown-menu\"],[11,\"class\",\"heading-anchor\"],[9],[0,\"Dropdown Menu\"],[10],[10],[0,\"\\n    \"],[7,\"p\"],[9],[0,\"Most uses of uxs-menu will involve only displaying it on clicking the menu text/icon. UXS includes \"],[7,\"a\"],[11,\"href\",\"https://github.com/cibernox/ember-basic-dropdown\"],[11,\"class\",\"docs-md__a\"],[9],[0,\"ember-basic-dropdown\"],[10],[0,\" to use in this scenario.\"],[10],[0,\"\\n\"],[7,\"p\"],[9],[0,\"You can use any component to act as your trigger (usually button, text or icon) and then include a uxs-menu in the dropdowns content.\"],[10],[0,\"\\n\"],[7,\"p\"],[9],[1,[21,\"docs/uxs-menu/dropdown-demo\"],false],[10],[0,\"\\n\"],[7,\"p\"],[9],[1,[21,\"args-table/align-options\"],false],[0,\"\\n\"],[1,[21,\"args-table/size-options\"],false],[0,\"\\n\"],[1,[21,\"args-table/style-options\"],false],[0,\"\\n\"],[1,[21,\"args-table/weight-options\"],false],[10],[10]],\"hasEval\":false}", "meta": { "moduleName": "dummy/templates/docs/components/menus.hbs" } });
});
