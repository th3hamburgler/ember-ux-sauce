...
test('it renders a date control bound to a model property', function(assert) {
  ...
  this.render(hbs `{{#uxs-form-control name="date" model=model as |control|}}
...
test('it renders a date control bound to a model property', function(assert) {
  ...
  assert.equal($input.attr("class"), 'uxs-form__input uxs-form__input--datetime ember-view flatpickr-input', 'Has correct classes');
