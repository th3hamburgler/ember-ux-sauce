...
import layout from '../../templates/components/uxs-header/logo';
...
/**
  ...
  ```hbs
  {{#uxs-header/logo "logo" svg=true}}

  {{#uxs-header/logo "logo.jpg" svg=false}}
  ```
...
export default Component.extend(Accessible, BEMComponent, Testable, {
  ...
  /**
    ...
    @argument base
    @type     String
    @default  "uxs-header__logo"
    @public
   */
  base: 'uxs-header__logo',
  /**
