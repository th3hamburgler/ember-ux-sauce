...
import layout from '../../templates/components/uxs-data/tip';

/**
  A component to render a data tip
...
export default Component.extend(BEMComponent, Datable, Groupable, Testable, Textable, {
  ...
  */
  ...
  /**
    The text for the tip, this can be passed in at the first positional parameter
